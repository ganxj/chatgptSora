...
const PageComponent = ({
  ...
  return (
    <>
      ...
      />
      <main className="w-[95%] md:w-[65%] lg:w-[55%] 2xl:w-[45%] mx-auto h-full my-terms">
        <div className="p-6 prose mx-auto my-auto text-gray-300">
          ...
          <p>
            {data('h4_5_p')}<a
            href={`https://chatgptsora.co/${locale}/privacy-policy`}
            className={"text-white"}>https://chatgptsora.co/privacy-policy</a>
          </p>
          ...
          <p>
            {data('h4_8_p')}<a href="mailto:hi@chatgptsora.co" className={"text-white"}>hi@chatgptsora.co</a>.
          </p>
        </div>
      </main>
      <Footer
